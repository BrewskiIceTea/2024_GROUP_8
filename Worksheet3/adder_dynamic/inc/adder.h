...
/*
    ...
    which is different depending on the operating system we are using,
    and whether we are using or creating the library.
...
// Prototype for the function including the additional keyword
